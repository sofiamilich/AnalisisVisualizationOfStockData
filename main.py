...
def main():
    ...
    # Закомментируем вызов функции, чтобы создавать интерактивный график через plotly
    # # Plot the data dplt.create_and_save_plot(stock_data, ticker, period)
    # dplt.create_and_save_plot(stock_data, ticker, period, style)

    # Заменим вызов прошлой функции на эту строку
    dplt.create_interactive_plot(stock_data, ticker, period)
...
# Код без вывода интерактивного графика
# import data_download as dd
# import analysis_data_mean as da
# import os
# import data_plotting as dplt
